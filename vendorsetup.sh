...
git clone https://github.com/GuidixX/android_vendor_xiaomi_spes vendor/xiaomi/spes
...
rm -rf frameworks/base && git clone https://github.com/GuidixX/android_frameworks_base frameworks/base
